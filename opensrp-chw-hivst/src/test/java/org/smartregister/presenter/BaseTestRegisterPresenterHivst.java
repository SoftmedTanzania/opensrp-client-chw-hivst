...
@PrepareForTest(BaseHivstRegisterPresenter.class)
public class BaseTestRegisterPresenterHivst {
    @Mock
    protected BaseHivstRegisterPresenter baseHivstRegisterPresenter;

    @Mock
    protected HivstRegisterContract.Interactor interactor;
    @Mock
    protected HivstRegisterContract.Model model;
    @Mock
    protected HivstRegisterContract.View baseView;
    private BaseHivstRegisterPresenter presenter;

    @Before
    public void setUp() {
        MockitoAnnotations.initMocks(this);
        presenter = new BaseHivstRegisterPresenter(baseView, model, interactor);
    }
    ...
    public void getViewWhenViewIsNull() throws Exception {
        Assert.assertNull(Whitebox.invokeMethod(baseHivstRegisterPresenter, "getView"));
    }
