...
@PrepareForTest(BaseHivstCallDialogFragment.class)
public class BaseTestCallDialogFragmentHivst {
    @Spy
    public BaseHivstCallDialogFragment baseHivstCallDialogFragment;
    ...
    public void setUp() {
        ...
        Whitebox.setInternalState(BaseHivstCallDialogFragment.class, "MEMBER_OBJECT", memberObject);
    }
    ...
    public void setCallTitleFamilyHead() throws Exception {
        ...
        Whitebox.invokeMethod(baseHivstCallDialogFragment, "setCallTitle", viewGroup, view.getId(), "message");
    ...
    public void setCallTitle() throws Exception {
        ...
        Whitebox.invokeMethod(baseHivstCallDialogFragment, "setCallTitle", viewGroup, view.getId(), "message");
        Assert.assertEquals("message Hivst Client", textView.getText());
    }

    @Test(expected = Exception.class)
    public void initUI() throws Exception {
        Mockito.when(memberObject.getPhoneNumber()).thenReturn("123456789");
        Whitebox.invokeMethod(baseHivstCallDialogFragment, "initUI", viewGroup);
        PowerMockito.verifyPrivate(baseHivstCallDialogFragment).invoke("setCallTitle", viewGroup, view.getId(), "message");
