...
public class BaseHivstRegisterActivity extends BaseRegisterActivity implements HivstRegisterContract.View {
    ...
    public void startFormActivity(JSONObject jsonForm) {
        Intent intent = new Intent(this, BaseHivstRegisterActivity.class);
    ...
    public List<String> getViewIdentifiers() {
        return Arrays.asList(Constants.CONFIGURATION.HIVST_CONFIRMATION);
    }
    ...
    protected void registerBottomNavigation() {
        ...
        if (bottomNavigationView != null) {
            ...
            BottomNavigationListener familyBottomNavigationListener = new HivstBottomNavigationListener(this);
    ...
    protected void initializePresenter() {
        presenter = new BaseHivstRegisterPresenter(this, new BaseHivstRegisterModel(), new BaseHivstRegisterInteractor());
    }

    @Override
    protected BaseRegisterFragment getRegisterFragment() {
        return new BaseHivstRegisterFragment();
    }
    ...
    @Override
    public HivstRegisterContract.Presenter presenter() {
        return (HivstRegisterContract.Presenter) presenter;
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == Activity.RESULT_OK && requestCode == Constants.REQUEST_CODE_GET_JSON) {
            ...
            try {
                ...
                JSONArray fieldsOne = HivstJsonFormUtils.fields(form, Constants.STEP_ONE);
...
//                process hivst form
    ...
    public void startClientProcessing() {
        try {
            ...
            HivstUtil.getClientProcessorForJava().processClient(HivstUtil.getSyncHelper().getEvents(lastSyncDate, BaseRepository.TYPE_Unprocessed));
