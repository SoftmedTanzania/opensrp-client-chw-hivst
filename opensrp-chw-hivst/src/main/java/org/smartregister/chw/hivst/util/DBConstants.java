...
public class DBConstants {
    ...
    public final class KEY {
        ...
        public static final String DATE_CHW_HIVST_TEST = "date_chw_hivst_test";
        public static final String FEVER_HIVST_CHW = "fever_hivst_chw";
        public static final String FEVER_DURATION = "fever_duration";
        public static final String HIVST_RESULTS = "hivst_results";
        public static final String DATE_HF_HIVST_TEST = "date_hf_hivst_test";
        public static final String HIVST_TEST_DATE = "hivst_test_date";
        public static final String HIVST_TREAT = "hivst_treat";
        ...
        public static final String HIVST_EDU_CHW = "hivst_edu_chw";
        ...
        public static final String HIVST = "hivst";
        public static final String FAMILY_NAME = "family_name";
        public static final String PHONE_NUMBER = "phone_number";
        public static final String PHONE_NUMBER_HIVST = "phoneNumberHivst";
        public static final String GEST_AGE = "gest_age";
        public static final String DELIVERY_DATE = "delivery_date";
        public static final String HIVST_FOLLOW_UP_DATE = "date_chw_mfollowup";
