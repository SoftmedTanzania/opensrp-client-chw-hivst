...
import org.smartregister.chw.hivst.listener.BaseHivstCallWidgetDialogListener;
import org.smartregister.hivst.R;

import static android.view.View.GONE;
import static org.smartregister.util.Utils.getName;

public class BaseHivstCallDialogFragment extends DialogFragment implements BaseHivstCallDialogContract.View {
    ...
    public static BaseHivstCallDialogFragment launchDialog(Activity activity, MemberObject MO) {
        BaseHivstCallDialogFragment dialogFragment = BaseHivstCallDialogFragment.newInstance();
    ...
    public static BaseHivstCallDialogFragment newInstance() {
        return new BaseHivstCallDialogFragment();
    }
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
        ...
        setUpPosition();
        if (listener == null) {
            listener = new BaseHivstCallWidgetDialogListener(this);
        }
    ...
    @Override
    public void setPendingCallRequest(BaseHivstCallDialogContract.Dialer dialer) {
