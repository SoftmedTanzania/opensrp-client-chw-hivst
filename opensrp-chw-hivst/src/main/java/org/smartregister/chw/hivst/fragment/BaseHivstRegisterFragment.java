...
public class BaseHivstRegisterFragment extends BaseRegisterFragment implements HivstRegisterFragmentContract.View {
    public static final String CLICK_VIEW_NORMAL = "click_view_normal";
    public static final String FOLLOW_UP_VISIT = "follow_up_visit";

    @Override
    public void initializeAdapter(Set<View> visibleColumns) {
        BaseHivstRegisterProvider baseHivstRegisterProvider = new BaseHivstRegisterProvider(getActivity(), paginationViewHandler, registerActionHandler, visibleColumns);
        clientAdapter = new RecyclerViewPaginatedAdapter(null, baseHivstRegisterProvider, context().commonrepository(this.tablename));
    ...
    @Override
    public HivstRegisterFragmentContract.Presenter presenter() {
        return (HivstRegisterFragmentContract.Presenter) presenter;
    }
    ...
    protected void initializePresenter() {
        ...
        presenter = new BaseHivstRegisterFragmentPresenter(this, new BaseHivstRegisterFragmentModel(), null);
    }
...
//        start forms here if the module requires registration
    ...
    protected void openProfile(String baseEntityId) {
        BaseHivstProfileActivity.startProfileActivity(getActivity(), baseEntityId);
    }
