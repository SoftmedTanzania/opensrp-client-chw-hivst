package org.smartregister.chw.hivst;
...
public class HivstLibrary {
    private static HivstLibrary instance;
    ...
    public static void init(Context context, Repository repository, int applicationVersion, int databaseVersion) {
        if (instance == null) {
            instance = new HivstLibrary(context, repository, applicationVersion, databaseVersion);
        }
    }

    public static HivstLibrary getInstance() {
        if (instance == null) {
    ...
    private HivstLibrary(Context contextArg, Repository repositoryArg, int applicationVersion, int databaseVersion) {
